...
function Navbar() {
  return (
    <div className='bg-black text-white text-sm '>
        <nav className=' flex items-center no-underline justify-between px-20 py-3'>
            <Link to={"/"}>
            ...
            <ul className='flex items-center gap-16'>
                ...
                <Link to={"/Signin"}><button className='bg-[#24CFA6] p-2 px-6 rounded-md text-black font-semibold'>Sign in</button></Link>
            </ul>
        </nav>
    </div>
  )
